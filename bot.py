...
- В imaging используй медицинские термины из отчета: например "регургитация I степени", а не бытовые слова вроде "микротечи".
- Избегай alarm phrasing вроде "красный флаг", если нет реальной экстренной ситуации.
...
- Не пиши "не ограничивает тренировки" как абсолют. Пиши: "если нет симптомов и врач не давал ограничений, это обычно не меняет базовый план".
